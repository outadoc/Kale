...
data class Rpl471Message(val source: String, val target: String, val contents: String): IMessage {
    ...
    companion object Factory: IMessageFactory<Rpl471Message> {
        ...
        override fun parse(message: IrcMessage): Rpl471Message? {
            ...
            return Rpl471Message(source = source, target = target, contents = contents)
        }
    }
}