...
data class Rpl473Message(val source: String, val target: String, val contents: String): IMessage {
    ...
    companion object Factory: IMessageFactory<Rpl473Message> {
        ...
        override fun parse(message: IrcMessage): Rpl473Message? {
            ...
            return Rpl473Message(source = source, target = target, contents = contents)
        }
    }
}