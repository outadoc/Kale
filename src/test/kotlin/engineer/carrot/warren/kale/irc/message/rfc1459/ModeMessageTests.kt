...
class ModeMessageTests {
    ...
    @Test fun test_parse_AddingSingleMode() {
        ...
        val firstModifier = ModeMessage.Factory.ModeModifier(type = '+', mode = 'A')
    ...
    @Test fun test_parse_AddingMultipleModes_SingleParameter() {
        ...
        val firstModifier = ModeMessage.Factory.ModeModifier(type = '+', mode = 'i')
        val secondModifier = ModeMessage.Factory.ModeModifier(type = '+', mode = 'm')
        val thirdModifier = ModeMessage.Factory.ModeModifier(type = '+', mode = 'I', parameter = "*!*@*.fi")
    ...
    @Test fun test_parse_AddingModesSeparately_SingleParameterEach() {
        ...
        val firstModifier = ModeMessage.Factory.ModeModifier(type = '+', mode = 'b', parameter = "*!*@*.edu")
        val secondModifier = ModeMessage.Factory.ModeModifier(type = '+', mode = 'e', parameter = "*!*@*.bu.edu")
    ...
    @Test fun test_parse_SettingChannelKeyExample() {
        ...
        val firstModifier = ModeMessage.Factory.ModeModifier(type = '+', mode = 'k', parameter = "oulu")
    ...
    @Test fun test_parse_AddingAndRemovingModes_InOneChunk() {
        ...
        val firstModifier = ModeMessage.Factory.ModeModifier(type = '+', mode = 'o', parameter = "nick1")
        val secondModifier = ModeMessage.Factory.ModeModifier(type = '-', mode = 'o', parameter = "nick2")
    ...
    @Test fun test_parse_ListingExceptionMasksExample() {
        ...
        val firstModifier = ModeMessage.Factory.ModeModifier(mode = 'e')
    ...
    @Test fun test_parse_UserMode_TurnOffWallOpsExample() {
        ...
        val firstModifier = ModeMessage.Factory.ModeModifier(type = '-', mode = 'w')
